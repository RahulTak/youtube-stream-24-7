...
final class ManageController extends Controller {
    ...
    public function diagnostics(): never { $stream=$this->streams->active();$this->view('diagnostics',['report'=>$this->healthChecks->report($stream),'streamDiagnostics'=>$this->streamDiagnostics->read($stream),'v4'=>$this->v4->snapshot($stream),'active'=>$stream]); }
