...
use App\Services\{ChannelService,HealthCheckService,ImportService,LogService,PlaylistService,SettingsService,StreamService,VideoService};
final class ManageController extends Controller {
    ...
    public function diagnostics(): never { $this->view('diagnostics',['report'=>$this->healthChecks->report($this->streams->active())]); }
