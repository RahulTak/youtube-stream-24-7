...
$router=new Router(new Container());require dirname(__DIR__).'/routes/web.php';$router->add('GET','/diagnostics',[App\Controllers\ManageController::class,'diagnostics']);$router->dispatch();
